...
"use strict";$(window).on("load",function(){$(".filter__container").on("input submit",function(e){e.preventDefault(),function(e,t){try{history.replaceState(null,null,"#")}catch(e){console.log(e)}$.ajax({url:t,type:"POST",dataType:"html",data:$("."+e).serialize(),success:function(e){var t=$.parseJSON(e);console.log(t)},error:function(e){alert("Ошибка. Данные не отправлены.")}})}("filter__container","test.php")}),$("#menu-element-more").on("click",function(){$(".menu__desktop-more-list").slideToggle(400),$("#menu-element-more").toggleClass("menu__desktop-element--open")}),$(".filters__switch-text").on("click",function(){$(".filters__switch-text").parent().toggleClass("filters__switch--active"),$(".filters__switch-modal").slideToggle(400)}),$(".filters__switch-modal-label").on("click",function(e){$(e.target).hasClass("filters__switch-modal-label--custom")||($(".filters__switch-text").text($(e.target).text()),$(".filters__switch-modal").toggle(0),$(".filters__switch").toggleClass("filter-switch--active"))}),$(".filter__date-element").on("click",function(){$(".filter__date-element").removeClass("filter__date-element--active"),$(this).addClass("filter__date-element--active")}),pageYOffset?$(".header").addClass("header--scroll"):$(".header").removeClass("header--scroll"),$(window).on("scroll",function(){pageYOffset?$(".header").addClass("header--scroll"):$(".header").removeClass("header--scroll")});new Swiper(".poster-slider__slider",{spaceBetween:20,slidesPerView:"auto",grabCursor:!0})});
//# sourceMappingURL=data:application/json;charset=utf8;base64,
